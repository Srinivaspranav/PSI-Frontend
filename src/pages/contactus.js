    ...
    <div className="appContact">
      ...
      <div className='pane'>
        ...
        <div className="detailsSection">
          <div className='dbox'>
            <div className="detailsField"><p className='detailsName'>Name:</p><input type='text' /></div>
            <div className="detailsField"><p className='detailsName'>Email ID:</p><input type='text' /></div>
            <div className="detailsField"><p className='detailsName'>Institution:</p><input type='text' /></div>
            <div className="detailsField"><p className='detailsName'>Phone Number:</p><input type='text' /></div>
            <div className="detailsField"><p className='detailsName'>Country:</p><input type='text' /></div>
            <textarea
            style={{
              height: "300px",
              width: "100%",
